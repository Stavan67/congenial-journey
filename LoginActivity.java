...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SharedPreferences firstLaunchPref = getSharedPreferences("LaunchPrefs", MODE_PRIVATE);
        boolean isFirstLaunch = firstLaunchPref.getBoolean("isFirstLaunch", true);

        String registrationStatus = sessionManager.getRegistrationStatus();

        if (registrationStatus.equals(SessionManager.REGISTRATION_STATUS_NONE)) {
            // New user, go to signup
            navigateToSignup();
            return;
        } else if (registrationStatus.equals(SessionManager.REGISTRATION_STATUS_PENDING)) {
            // Registration pending, go to pending screen
            Intent intent = new Intent(LoginActivity.this, PendingApprovalActivity.class);
            startActivity(intent);
            finish();
            return;
        } else if (registrationStatus.equals(SessionManager.REGISTRATION_STATUS_REJECTED)) {
            // Registration rejected, go to rejected screen
